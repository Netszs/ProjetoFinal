...
public class FrmPedido extends javax.swing.JInternalFrame {
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        Cliente cliente = new Cliente(idCli, txtNome.getText(), txtPedido.getText(), txtLanche.getText(),
    ...
    private void TablePedidoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablePedidoMouseClicked
        ...
        txtPedido.setText(cliente.getDescricao());
        txtLanche.setText(cliente.getPedido());
        txtDescricao.setText(cliente.getNumeroVenda());
