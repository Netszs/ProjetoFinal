...
public class Funcionario extends Pessoa{
    ...
    public Funcionario(int id, String nome, String numeroCartaoPonto, String descricao, String pedido, String numeroVenda)
    {
        super(id, nome, descricao, pedido, numeroVenda);
